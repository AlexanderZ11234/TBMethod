...
PhotonBlocks::usage = "Generates the Floquet dressing coefficient for a certain hopping amplitude due to a periodical driving, e.g., a light driven field via Peierls's substitution.";
